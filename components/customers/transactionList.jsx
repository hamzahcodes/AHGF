  ...
  return (
    ...
    
    {
        data?.map((data,key)=> (
          ...
          <button onClick={() => {total === 0 ? alert('To add a transcation please set a total amount in Goat specificities tab...') : document.getElementById('my_modal_15').showModal()}} className='flex justify-center items-center text-5xl fixed bottom-[10%] right-[5%] w-[70px] h-[70px] rounded-full bg-[#0096D6] text-[#fff]'>
