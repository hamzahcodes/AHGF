...
const GoatList = ({ data, id }) => {
    return (
        <>
            ...
            <button onClick={() => document.getElementById('my_modal_10').showModal()} className='text-5xl flex justify-center items-center fixed bottom-[10%] right-[5%] w-[70px] h-[70px] rounded-full bg-[#0096D6] text-[#fff]'>
