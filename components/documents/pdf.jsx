    ...
    return (
        <Document>
            ...
            <View style={{display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexDirection: "row", gap: "30", backgroundColor:'#39A7FF','color':'#000', 'borderRadius':'10','padding':'10 10' }}>
                ...
                <Text style={styles.title}>{customerData.basic_details.username} Statement</Text>
                <Text style={{ ...styles.content_2 }}>Phone Number: {customerData.basic_details.phone_no}</Text>
