...
<View style={{display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexDirection: "row", gap: "30", backgroundColor:'#39A7FF','color':'#000', 'borderRadius':'10','padding':'10 10' }}>
    ...
    <View style={{ margin: '10 0' }}>
        <Text style={{ ...styles.content_2, fontSize: '24', fontWeight: '900', textAlign: 'center' }}>Delivery Note</Text>
        <Text style={{ ...styles.content_2, fontSize: '18', fontWeight: '600', textAlign: 'left' , marginTop: '10', marginLeft: '10' }}>Shipping Details</Text>
    </View>

    <View style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: "row", marginTop: '10', gap: '40', marginLeft: '10' }}>
        <Text style={{ ...styles.content_2, fontSize: '16', fontWeight: '600', textAlign: 'center' }}>Delivered To: {buyerDetails?.deliveredTo}</Text>
        <Text style={{ ...styles.content_2, fontSize: '16', fontWeight: '600', textAlign: 'center' }}>Phone: {buyerDetails?.phone}</Text>
    </View>

    <View style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: "row", marginTop: '10', gap: '20', marginLeft: '10' }}>
        <Text style={{ ...styles.content_2, fontSize: '16', fontWeight: '600', textAlign: 'center' }}>Address: {buyerDetails?.address}</Text>
    </View>
    ...
    <View style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', flexDirection: "row", marginTop: '10', gap: '40', marginLeft: '10' }}>
        ...
        <Text style={{ ...styles.content_2, fontSize: '16', fontWeight: '600', textAlign: 'center' }}>Expected Arrival Date: {buyerDetails?.expectedDateToReach.toString().split("-").reverse().join("/")}</Text>
    </View>
