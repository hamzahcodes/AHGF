...
const InvoicePdfTemp = ({ tableDetails, buyerDetails }) => {
  let total = 0;
  if (Array.isArray(tableDetails)) {
    total = tableDetails.reduce(
...
const InvoicePdf = ({ tableDetails, buyerDetails }) => {
  return (
    <PDFDownloadLink
      ...
      document={
        <InvoicePdfTemp buyerDetails={buyerDetails} tableDetails={tableDetails} />
      }
